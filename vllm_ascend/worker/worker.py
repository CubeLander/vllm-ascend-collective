...
class NPUWorker(WorkerBase):
    ...
    def compile_or_warm_up_model(self) -> CompilationTimes:
        ...
        # decode phase, which under the policy bypasses the compiled model
        # (skip_compiled=True) and would never compile the fused artifact
        # before decode capture. Policy off keeps the historical
